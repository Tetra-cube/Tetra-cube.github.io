const canvasWidth = 400,
    ...
    spriteHeight = 256,
    spriteOff = 28,
    darkenConst = 0.25, // For sprite drawing
    leftX = -27,
    topY = 146,
    namePlateMargin = 126,
    namePlateY = 161,
    namePlateTextY = 178,
    talkCursorY = 216,
    talkCursorMargin = 78, // For textbox drawing
    dialogue1Y = 202,
    dialogue2Y = 224,
    leftTextMargin = 57,
    rightTextMargin = -159 // For text drawing

allIDs = ["lp", "rp", "lp2", "rp2"], leftTextBoxOffsetValues = [0, 0, 4, 8, 12, 16], centerPiecesMax = [0, 12, 12, 11, 11, 10],
    offset = {
        "lp": 0,
        "rp": canvasWidth - spriteWidth,
        "lp2": 0,
        "rp2": canvasWidth - spriteWidth
    },
    flipOffset = {
        "lp": -spriteWidth,
        "rp": -canvasWidth,
...
var ctx, shadingCTX, reader,
    ...
    textBoxLeftImages = [],
    textBoxRightImages = [],
    textBoxCenterImage, namePlateImage, talkCursorImage, darkenImage, backgroundImage;
...
$(function() {
    ...
    $("#l-box-radio").on("change", function() {
        HTMLFunctions.UpdateDarkBoxes("left");
    });
    $("#r-box-radio").on("change", function() {
        HTMLFunctions.UpdateDarkBoxes("right");
    });
    $("#no-box-radio").on("change", function() {
        HTMLFunctions.UpdateDarkBoxes("none");
    });
